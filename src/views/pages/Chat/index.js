            ...
            <Box display='flex' alignItems='center'>
                ...
                <Box m={1}>
                    ...
                    <Typography component="p" variant="body2">
                        {isOnline ? t('Online') : t('Active recently')}
                    </Typography>
                </Box>
            </Box>
            {/* End User`s avatar */}
                    ...
                    Header: () => {
                        return theStart ?
                            <Box width='100%' align='center'>
                                <Typography component="h5" variant="h5">{t('Chat started')}</Typography>
                                <Typography component="p" variant="body2">
                    ...
                    {({
                        ...
                        return (
                            <>
                                ...
                                {imageList.length > 1 && <Button onClick={onImageRemoveAll}>{t('Remove all images')}</Button>}
                                {imageList.length > 0 &&
        ...
        <Box className={classes.container}>
            ...
            >
                ...
                <List>
                    <ListItem>
                        {isConnected ?
                            <Box padding={1} fontSize={12}>🟢 {t('Online users')} ({onlineUsers.length})</Box> :
                            <Box padding={1} fontSize={12}>⛔ {t('Chat disconnected, retrying')} ... </Box>
                        }
                    </ListItem>
                </List>
                <Divider/>
            ...
            {chatId == 't' ?
                <Box className={classes.main}
                    ...
                    <Typography component="h2" variant="h2" align='center'>
                        {t('Kick start chat now!')} <br/> {t('Say Hi 👊 to your MAS community')}
                    </Typography>
                </Box> : null}
